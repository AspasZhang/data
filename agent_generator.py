...
class AgentGenerator:
    ...
    def generate(self, question: str, run_config: Optional[Dict] = None) -> Dict[str, Any]:
        """
        生成一次诊断数据
    ...
    def generate_batch(self, question: str, n_runs: int = 10, 
                      output_dir: str = "/mnt/user-data/outputs") -> List[Dict]:
        """
        批量生成多条数据
        ...
        for i in range(n_runs):
            ...
            # 执行生成
            result = self.generate(question, config)
