...
class EnhancedWorldModel:
    ...
    def _generate_tool_response(self, tool_name: str, tool_request: Dict, 
                               variant: Dict, context: Dict, cot: str = None) -> Dict[str, Any]:
        """
        生成工具响应
        ...
        """
        # 构建prompt
        prompt = self._build_generation_prompt(tool_name, tool_request, variant, context, cot)
    ...
    def _build_generation_prompt(self, tool_name: str, tool_request: Dict,
                                 variant: Dict, context: Dict, cot: str = None) -> str:
        """构建生成prompt"""
...
- 例如：如果规划器说"检查接口是否有CRC错包"，响应中应包含CRC相关字段
"""
